...
```
9. Add the public keys to your user's (not root) `~/.ssh/authorized_keys` file (or if created on the client by using the `ssh-copy-id` utility (Google is your friend(?)).
